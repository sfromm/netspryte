...
DEFAULT_MONGO_NAME          = get_config(p, 'mongo', 'name', 'NETSPRYTE_MONGO_NAME', 'netspryte')
DEFAULT_MONGO_HOST          = get_config(p, 'mongo', 'host', 'NETSPRYTE_MONGO_HOST', 'localhost')
DEFAULT_MONGO_PORT          = get_config(p, 'mongo', 'port', 'NETSPRYTE_MONGO_PORT', 27017, integer=True)
